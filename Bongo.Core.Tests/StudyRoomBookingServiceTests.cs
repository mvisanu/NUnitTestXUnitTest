...
namespace Bongo.Core.Tests
{
    ...
    public class StudyRoomBookingServiceTests
    {
        ...
        public StudyRoomBookingCode ResultCodeSuccess_RoomAvailability_ReturnSuccessResultCode(bool roomAvail)
        {
            if (!roomAvail)
            {
        ...
        [TestCase(0, false)]
        [TestCase(55, true)]
        public void StudyRoomBooking_BookRoomWithAvailability_ReturnsBookingId(int expectedBookingId, bool roomAvailablity)
        {
            //Arrange
            if (!roomAvailablity)
            {
        ...
        [Test]
        public void BookNotInvoked_SaveRoomWithoutAvailableRoom_BookMethodNotInvoked()
        {
            //Arrange               
             _availableStudyRoom.Clear();
